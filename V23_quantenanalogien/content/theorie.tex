...
\begin{figure}[H]
\centering
\subcaptionbox{Luftbewegungen und Druckschwankungen bei einer stehenden Welle in einem Rohr \cite{stehendeWelle}\label{fig:stehendeWelle}.}%
  [.4\linewidth]{\includegraphics[width=.4\linewidth]{data/stehendeWelle.png}}
\,\,\,\,\,\,\,\,\,\,\,\,
\subcaptionbox{descriptioner ersten vier Wellenfunktionen im unendlich hohen Potenzialtopf \cite{kasten}\label{fig:kasten}.}
  [.4\linewidth]{\includegraphics[width=.4\linewidth]{data/kasten.png}}
\caption{Schematische Darstellungen der beiden hier betrachteten eindimensionalen Probleme.}\label{fig:zweiAbbildungen}
\end{figure}
