...
\end{equation}
gegeben.\\
Die Wellenfunktionen werden Atomorbitale genannt. In Abbildung \ref{fig:orbitale} wird die Aufenthaltswahrscheinlichkeit farbig dargestellt, um die räumliche Form der Orbitale darzustellen.
