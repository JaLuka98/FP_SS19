...
wird im xy-Modus verwendet und es werden Moden sichtbar gemacht. Diese haben einen
Verlauf wie er in Abbildung \ref{fig:mode} dargestellt ist.

\begin{figure}
  \centering
  \includegraphics[width=130pt]{data/mode.png}
...
Maximums und dessen Amplitude bestimmt.

\begin{figure}
  \centering
  \includegraphics[width=130pt]{data/seite.png}
...
\begin{figure}
  \centering
  \includegraphics[width=130pt]{data/dip.png}
